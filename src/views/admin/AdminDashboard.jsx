...
const AdminDashboard = () => {
  ...
  const state = {
    ...
    options: {
      ...
      strock: { show: true, curve: ["smooth", "straight", "stepline"], lineCap: "butt", colors: "#f0f0f0", width: 0.5, dashArray: 0 },
      xaxis: { categories: ["Jan", "Feb", "Mar", "Apl", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"] },
      legend: { position: "top" },
      responsive: [
        {
          breakpoint: 565,
          yaxis: { categories: ["Jan", "Feb", "Mar", "Apl", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"] },
          options: { plotOptions: { bar: { horizontal: true } }, chart: { height: "550px" } },
        },
      ],
    },
  };
    ...
    <div className="px-2 md:px-7 pb-20">
        ...
        <div className="w-full lg:w-5/12 lg:pl-4 mt-6 lg:mt-0">
          <div className="w-full bg-[#6a5fdf] p-4 rounded-md text-[#d0d2d6]">
            <div className="flex justify-between items-center">
              ...
              <Link to="/admin/dashboard/chat-sellers" className="font-semibold text-sm text-[#d0d2d6] hover:text-white transition-colors">
                View All
              </Link>
            </div>
      ...
      <div className="w-full p-6 sm:p-8 bg-white rounded-2xl shadow-xl border border-slate-200/50 mt-6">
        <div className="flex justify-between items-center pb-4 mb-2 border-b border-slate-200">
          ...
          <Link to="/admin/dashboard/orders" className="font-semibold text-sm text-indigo-600 hover:text-indigo-700 transition-colors">
            View All
          </Link>
        </div>
            ...
            <tbody className="bg-white">
              {recentOrder.map((d, i) => (
                <tr key={i} className="border-b border-slate-100 hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 transition-all duration-300">
                  <td className="py-4 px-6 font-semibold whitespace-nowrap text-slate-800">
                   #{d._id}
                  </td>
                  <td className="py-4 px-6 font-bold whitespace-nowrap text-green-600">
                    ${d.price}
                  </td>
                  ...
                  <td className="py-4 px-6 font-medium whitespace-nowrap">
                    <Link to={`/admin/dashboard/order/details/${d._id}`} className="px-4 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg hover:from-indigo-700 hover:to-purple-700 hover:shadow-lg hover:scale-105 transition-all duration-300 active:scale-95 inline-block font-semibold text-xs">
                      View
                    </Link>
                  </td>
                </tr>
