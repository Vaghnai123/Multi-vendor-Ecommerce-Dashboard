...
import { get_seller_order,seller_order_status_update,messageClear } from '../../store/Reducers/couponReducer';
                ...
                <div className='bg-white rounded-2xl shadow-sm border border-slate-200 p-6 h-full'>
                    ...
                    <div className='space-y-3 pl-1'>
                        <div className='pt-2'>
                            ...
                            <p className='text-slate-700 pt-2 font-semibold text-base'>{order.shippingInfo} </p>
                        </div>
                        <div className='pt-2'>
                            <p className='text-xs pb-3 text-slate-400 uppercase font-bold tracking-wider mb-1'>Address</p>
                            <div className='flex items-start gap-2'>
                                <span className='bg-blue-100 text-blue-700 text-[10px] font-bold px-2 py-0.5 rounded uppercase tracking-wide mt-0.5'>Warehouse</span>
                                <span className='text-slate-800 text-sm font-medium'>
                                    Atlanta Mainfreight Warehousing, located at 4900 North Commerce Drive, East Point, GA 30344, United States
                                </span>
                            </div>
                        </div>
                    </div>
