...
<div style={style} className="flex items-center text-xs sm:text-sm font-medium border-b border-slate-100 hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 transition-all duration-300">
    ...
    <div className="w-[25%] p-2 sm:p-3 whitespace-nowrap text-slate-800 font-semibold">{index + 1}</div>
    <div className="w-[25%] p-2 sm:p-3 whitespace-nowrap text-green-600 font-bold">$3434</div>
    ...
    <div className="w-[25%] p-2 sm:p-3 whitespace-nowrap text-slate-600 text-[11px] sm:text-sm">25 Dec 2025</div>
        ...
        <div className="px-2 md:px-7 pb-18 bg-[#cdcae9] min-h-screen">
          ...
          <div className='w-full grid grid-cols-1 md:grid-cols-2 gap-5 pb-4'>
            <div className='bg-white border border-slate-200 rounded-2xl shadow-xl p-6'>
              <h2 className='text-slate-800 text-xl font-bold mb-5'>Send Request</h2>
              <div className='mb-6'>
                  <form>
                      <div className='flex gap-3 flex-wrap'>
                        <input min='0' type="number" className='px-4 py-3 md:w-[70%] focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 outline-none bg-slate-50 border border-slate-300 rounded-lg text-slate-700 placeholder-slate-400' name='amount' placeholder='Enter amount' />
                        <button className='bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 hover:shadow-lg text-white font-semibold rounded-lg px-7 py-3 transition-all duration-300 hover:scale-105 active:scale-95'>Submit</button>
                      </div>
                </form> 
              </div>

              <div>
                    <h2 className='text-slate-800 text-lg font-bold mb-4'>Pending Request</h2>
            ...
            <div className='bg-white border border-slate-200 rounded-2xl shadow-xl p-6'>
              <div>
                    <h2 className='text-slate-800 text-lg font-bold mb-4'>Success Withdrawal</h2>
